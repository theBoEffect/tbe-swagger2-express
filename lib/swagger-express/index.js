...
function readYml(file, fn) {
    ...
    //descriptor.paths = (api.paths);
    for (var key in api.definitions){
        descriptor.definitions[key] = api.definitions[key];
        resources[resource.definitions[key]] = resource.definitions[key];
    }
